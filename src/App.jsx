// ===================== FULL APP.JSX WITH SECTION BACKGROUNDS =====================
...
const App = () => {
  ...
  const projects = [
    {
      ...
      github: "https://github.com/vinit-solanki/Tunist",
    ...
    },
    {
      ...
      description:
        "Data Analysis (Pandas+Numpy+Matplotlib/Seaborn) + Visualization (PowerBI).",
      tech: ["Python", "Pandas", "NumPy", "Matplotlib", "PowerBI"],
      github:
    ...
    },
    {
      ...
      description:
        "Built ANN for churn prediction using CrewAI + Gemini API + Streamlit.",
      tech: ["Python", "Deep Learning", "Pandas", "Streamlit", "Flask"],
    ...
    },
    {
      ...
      description: "XGBoost forecasting models for Mumbai AQI monitoring.",
      tech: ["Python", "Time Series", "XGBoost"],
      github: "https://github.com/vinit-solanki/AQI-Prediction-System-Using-XGBoost",
      demo: "",
      gradient: "from-orange-500 via-red-500 to-pink-500",
    },
    {
      name: "Streaming Website Frontend",
      tagline: "Frontend for OTT VFLIX",
      description:
        "A responsive streaming website frontend using React.js + Tailwind.",
  ...
  const timeline = [
    {
      ...
      description:
        "Built AQI Forecasting System using advanced Time Series Analysis.",
      color: "blue",
    },
    {
      type: "education",
      ...
      description: "CGPI: 8.82 • ML, DBMS, CN, Software Engineering.",
      color: "purple",
    },
    {
      type: "leadership",
      ...
      description:
        "Event management, graphics, bootcamps, website development.",
      color: "pink",
    },
  ];
  ...
  const achievements = [
    ...
    "Nvidia Deep Learning Foundation Certified",
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
        ...
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat blur-m opacity-90"
          style={{ backgroundImage: "url('/src/assets/batman-bg.jpg')" }}
        ></div>
        ...
        <div className="relative z-20 max-w-5xl w-full text-center space-y-8">
          ...
          <h1 className="text-6xl md:text-8xl font-black tracking-tight bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
            Vinit Solanki
          </h1>
          ...
          <div className="flex flex-wrap gap-4 justify-center pt-6">
            <a
              href="#projects"
              className="group px-8 py-4 bg-white text-black rounded-full font-semibold"
            >
              View My Work
      ...
      <section className="relative py-20 px-6">
        ...
        <div
          ...
          style={{ backgroundImage: "url('/src/assets/batman-skills.jpg')" }}
        ></div>
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-bold mb-4 text-white  text-transparent">
              Technical Arsenal
            </h2>
      ...
      <section id="projects" className="relative py-20 px-6">
        ...
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat blur-m opacity-90"
          style={{ backgroundImage: "url('/src/assets/batman-projects.jpg')" }}
        ></div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {projects.map((project, idx) => (
              <div key={idx} className="group relative p-8 bg-white/5 border border-white/10 rounded-3xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-10 transition"></div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex justify-between mb-4">
                    ...
                    <div className="flex gap-2">
                      <a href={project.github} className="p-2 bg-white/5 rounded-lg">
                        <Github size={20} />
                      </a>

                      {project.demo !== "#" && (
                        <a href={project.demo} className="p-2 bg-white/5 rounded-lg">
      ...
      <section className="relative py-20 px-6">
        ...
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-90"
          style={{ backgroundImage: "url('/src/assets/batman-journey.jpg')" }}
        ></div>
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg">Experience & Education</p>
          </div>
      ...
      <section id="contact" className="relative py-20 px-6">
        ...
        <div
          ...
          style={{ backgroundImage: "url('/src/assets/batman-footer.jpg')" }}
        ></div>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-5xl md:text-6xl font-bold mb-8 text-white bg-clip-text text-transparent">
            Let's Work Together
          </h2>
  ...
  <a
    href="https://x.com/VINITSOLAN82916"
    className="p-4 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition"
  >
    <Twitter size={24} />
  </a>
  ...
  <a
    href="https://www.instagram.com/notanerd_005/"
    className="p-4 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition"
  >
    <Instagram size={24} />
  </a>
